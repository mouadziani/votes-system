        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="positions_add.php">
                ...
                <div class="form-group">
                    <label for="time_out_date" class="col-sm-3 control-label">Timeout</label>

                    <div class="col-sm-9">  
                      <input type="datetime-local" class="form-control" id="time_out_date" name="time_out_date" required>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="positions_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_time_out_date" class="col-sm-3 control-label">Timeout</label>

                    <div class="col-sm-9">  
                      <input type="text" class="form-control" id="edit_time_out_date" name="time_out_date" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
